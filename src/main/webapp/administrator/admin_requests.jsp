...
<head>
	...
	<link rel="stylesheet" href="/FamilyWeb/styles/admin_requests.css">
...
<body fullbleed layout vertical>
    <core-drawer-panel responsivewidth="1400px">
        <core-header-panel drawer>
            ...
            <responsive-menu-administrator current="1"></responsive-menu-administrator>
        </core-header-panel>
        <core-header-panel main>
			...
			<p>Hier moet een tabel komen met de verzoeken voor de admin</p>
            </div>
        </core-header-panel>
    </core-drawer-panel>
</body>
